...
<a onclick="closeVitList()"><i class="fas fa-times" id="vit_close"></i></a>
<script>
    function closeVitList() {
        var chatbox = document.getElementById("vit_list");
        chatbox.style.display = chatbox.style.display === "none" ? "block" : "none";
    }
</script>

<body>
    <p class="text-center fs-1">Vitamins Lists</p>
    <?php
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<input type='number' id='gotoPageV' class='form-control' min='1' max='$totalPages' placeholder='Page'>";
        echo "</div>";
        echo "<div class='col-md-1'>";
        echo "<button class='btn btn-danger' id='goButtonV'>Go</button>";
        echo "</div>";
